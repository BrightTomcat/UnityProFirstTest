...
{
    public sealed class ConveyorVisitObserver_AddResourcesToPlayer :
        IGameReadyElement,
        IGameFinishElement
    {
        ...
        {
            this.conveyorVisitor.OutputZone.OnEntered += this.OnConveyorEntered;
            this.conveyorVisitor.OutputZone.OnExited += this.OnConveyorExited;
        }
